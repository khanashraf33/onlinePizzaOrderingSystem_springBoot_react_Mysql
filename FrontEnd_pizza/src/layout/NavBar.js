  ...
  return (
   <div>
      ...
      <MDBNavbar expand='lg' dark bgColor='primary' className='fixed-top'>
        <MDBContainer fluid>
          <MDBNavbarBrand href='http://13.232.147.37:3000/'>PIZZATERIA</MDBNavbarBrand>
          <MDBNavbarToggler
            type='button'
          ...
          <MDBCollapse show={showNavColor} navbar>
            <MDBNavbarNav className='me-auto mb-2 mb-lg-0'>
              <MDBNavbarItem className='active'>
                <MDBNavbarLink aria-current='page' href='http://13.232.147.37:3000/'>
                  Home
                </MDBNavbarLink>
              </MDBNavbarItem>
              
              <MDBNavbarItem>
                <MDBNavbarLink href='http://13.232.147.37:3000/aboutus'>About</MDBNavbarLink>
              </MDBNavbarItem>

              <MDBNavbarItem>
                <MDBNavbarLink href='http://13.232.147.37:3000/contactus'>Contact Us</MDBNavbarLink>
              </MDBNavbarItem>
      ...
      <li key={categ.id}>
        ...
        >
          {categ.categoryName}
              ...
              <a href='http://13.232.147.37:3000/cart' className='btn btn-secondary' bgColor=''>
