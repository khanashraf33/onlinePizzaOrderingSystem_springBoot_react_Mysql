...
const [terms_conditions,setTerms_conditions]=useState("");
    ...
    // this.terms_conditions = terms_conditions;
        await axios.put(`http://13.233.168.239:8080/pizzadelivery/offer`,{
            id:id,
            name: name,
            discount: discount,
        ...
        history.push("/adminofferdisplay");
    }
    ...
    const getProductById = async () => {
        debugger;
        const response = await axios.get(`http://13.233.168.239:8080/pizzadelivery/offer/${id}`);
    // this.name = name;
    // this.discount = discount;
    // this.valid_upto = valid_upto;
    // this.valid_from = valid_from;
