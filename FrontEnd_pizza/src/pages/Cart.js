...
//     //     await axios.get(`http://13.233.168.239:8080/pizzadelivery/cart/${userId}`).then((res)=>{
//     //         setCart(res.data)
...
//     const loadCart = async () => {
//         try {
//           const response = await axios.get(`http://13.233.168.239:8080/pizzadelivery/cart/${userId}`);
//           const data = response.data;
//           setCart(data);
//           console.log("Inside Total cart price");
//           console.log(cart.totalCartPrice);
//           setDeliveryPrice((data.totalCartPrice > 500 || data.totalCartPrice === 0) ? 0 : 50);
//           console.log("Inside Cart");
//           console.log("res.data");
//           console.log(data);
//           console.log("res");
...
//     //     await axios.get(`http://13.233.168.239:8080/pizzadelivery/cartitems/${cartId}`).then((res)=>{
...
//         const loadItems = async () => {
//   try {
//     const res = await axios.get(`http://13.233.168.239:8080/pizzadelivery/cartitems/${cartId}`);
//     setCartItems(res.data);
//     console.log("Inside CartItems");
//     console.log("res.data");
//     console.log(res.data);
...
//                         <button type="button" onClick={() => history.push('/')} class="btn btn-primary">Go Back</button>
//                         Go back
//                         </>
//                     )
//                 }
