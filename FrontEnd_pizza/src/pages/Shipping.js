...
const Shipping = () => {
    ...
    const getAddressesByUser = async()=>{
        await axios.get(`http://13.233.168.239:8080/pizzadelivery/addressbyuser/${userId}`).then((res)=>{
    ...
    const loadItems= async ()=>{
        await axios.get(`http://13.233.168.239:8080/pizzadelivery/cartitems/${cart.id}`).then((res)=>{
    ...
    const deleteAddress = async(id)=>{
        try{
        await axios.delete(`http://13.233.168.239:8080/pizzadelivery/address/${id}`).then((res)=>{
            setAllAdresses(res.data)
